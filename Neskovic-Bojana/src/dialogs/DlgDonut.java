...
public class DlgDonut extends JDialog {
    ...
    public void fillUp(Donut donut, int drawWidth, int drawHeight) {
        txtXcoordinateOfCenter.setText(String.valueOf(donut.getCenter().getXcoordinate()));
        txtYcoordinateOfCenter.setText(String.valueOf(donut.getCenter().getYcoordinate()));
